...
// Kiểm tra xem ID có hợp lệ không (tránh lỗi SQL Injection)
if (!preg_match('/^[a-zA-Z0-9]+$/', $id)) {
    echo "<script>alert('Mã sản phẩm không hợp lệ!'); window.location.href = '/index.php';</script>";
    exit();
}
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="product-info">
                ...
                <p class="product-price"><?php echo number_format($product['DonGia']); ?> VND</p>
    ...
    <div class="related-products">
        ...
        <div class="related-list">
            <div class="related-item">
                <img src="/images/kemLyDau.jpg" alt="Kem Socola">
                <p>Kem Socola - 110,000 VND</p>
            </div>
            <div class="related-item">
                <img src="/images/kemLyVani.jpg" alt="Kem Vani">
                <p>Kem Vani - 100,000 VND</p>
            </div>
            <div class="related-item">
                <img src="/images/KemLySocola.jpg" alt="Kem Xoài">
                <p>Kem Xoài - 105,000 VND</p>
            </div>
        </div>
    </div>
</div>
