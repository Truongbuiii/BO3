...
var DoughnutChart = {
    datasets: [{
        data: [33,18,27,22], // Values of the segments
        backgroundColor: ["#fcc79e", "#ffddfb", "#fff5bc","#7cd13a"] // Colors of the segments
    }],
    labels: ["Đồng hồ nam", "Đồng hồ treo tường", "Đồng hồ nữ","Đồng hồ báo thức"] // Optional labels for each segment
};
